<template>
  <div class="container">
    <a href="https://Bachtiaryusuf11.pythonanywhere.com/books">lihat json</a><br>
...
export default {
    ...
    methods: {
      ...
      fetchBook() {
        axios
            .get('https://akbar-cors.herokuapp.com/https://isnever.pythonanywhere.com/books/')
            .then(response => {
      ...
      addBook() {
        ...
        axios.post('https://akbar-cors.herokuapp.com/https://Bachtiaryusuf11.pythonanywhere.com/books', data, {
          headers: {
      ...
      deleteBook(book) {
        axios.delete('https://akbar-cors.herokuapp.com/https://Bachtiaryusuf11.pythonanywhere.com/books/'+book.id )
      this.fetchBook()
      },
      ...
      saveBook(){
        axios.put('https://akbar-cors.herokuapp.com/https://Bachtiaryusuf11.pythonanywhere.com/books/'+this.id+'/', {
          author: this.author,
          title: this.title,
          published: this.published,
          first_sentence: this.first_sentence
